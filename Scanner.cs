...
public class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "byte": t.kind = 19; break;
			case "double": t.kind = 20; break;
			case "bool": t.kind = 21; break;
			case "string": t.kind = 22; break;
			case "Set": t.kind = 23; break;
			case "Of": t.kind = 24; break;
			case "BEGIN": t.kind = 26; break;
			case "END": t.kind = 27; break;
			case "AND": t.kind = 37; break;
			case "OR": t.kind = 38; break;
			case "Union": t.kind = 39; break;
			case "Cros": t.kind = 40; break;
			case "Res": t.kind = 41; break;
			case "Diff": t.kind = 42; break;
			case "GOTO": t.kind = 43; break;
			case "Read": t.kind = 44; break;
			case "Readln": t.kind = 45; break;
			case "Write": t.kind = 48; break;
			case "Writeln": t.kind = 49; break;
			case "IF": t.kind = 50; break;
			case "THEN": t.kind = 51; break;
			case "ELSE": t.kind = 52; break;
			case "WHILE": t.kind = 53; break;
			case "DO": t.kind = 54; break;
			default: break;
		}
	}
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 6:
				if (ch <= '!' || ch >= '#' && ch <= 65535) {AddCh(); goto case 6;}
